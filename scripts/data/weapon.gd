...
const CATALOGUE: Dictionary = {
	...
	"dueling_dagger": {
		...
		"power_rating":  2,
		"rarity":        Rarity.UNCOMMON,
		"flavour":       "Narrower than a parrying knife and meaner. The crowd sees a flourish; the wielder sees a window.",
	},
	"horseman_axe": {
		"name":          "Horseman's Axe",
		"weapon_type":   WeaponType.AXE,
		...
		"power_rating":  2,
		"rarity":        Rarity.UNCOMMON,
		"flavour":       "Short of haft, long of intent. Made to swing from the saddle and forgive a poor angle.",
	},
	"bastard_sword": {
		"name":          "Bastard Sword",
		"weapon_type":   WeaponType.SWORD,
		...
		"power_rating":  3,
		"rarity":        Rarity.RARE,
		"flavour":       "Hand-and-a-half. Two grips, one decision; the second hand arrives when the first runs out of opinion.",
	},
	"arbalest": {
		"name":          "Arbalest",
		"weapon_type":   WeaponType.CROSSBOW,
		...
		"power_rating":  3,
		"rarity":        Rarity.RARE,
		"flavour":       "Steel-armed, windlass-cocked, plate-ignoring. A herald is paid to keep its name out of the ballads.",
	},
